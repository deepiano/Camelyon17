...
path_save_location_17_normal_mask = \
    "/mnt/nfs/kyuhyoung/pathology/breast/bong/Slide_tissue_mask_lv_4/Train_17_Normal_of_Tumor/"
...
if __name__=='__main__':
    ...
    list_file_name_tissue_mask = [name for name in \
            listdir(path_tumor_slide_17_tissue_mask)]
    list_file_name_tissue_mask.sort()
    list_file_name_tumor_mask = [name for name in \
            listdir(path_tumor_slide_17_tumor_mask)]
    ...
    for i in range(len_):
        ...
        cur_path_tissue = path_tumor_slide_17_tissue_mask + \
                            file_name_tissue_mask
        cur_path_tumor = path_tumor_slide_17_tumor_mask + \
...
## camelyon 17
        ...
        cur_path_save = path_save_location_17_normal_mask + file_name_save
